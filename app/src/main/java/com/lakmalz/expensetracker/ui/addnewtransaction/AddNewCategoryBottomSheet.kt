...
class AddNewCategoryBottomSheet : BottomSheetDialogFragment() {
    ...
    companion object {
        ...
        fun open(fragmentManager: FragmentManager): AddNewCategoryBottomSheet {
            val view = AddNewCategoryBottomSheet()
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): BottomSheetDialog {
        ...
        mainView = View.inflate(context, R.layout.add_new_category_bottom_sheet, null)
