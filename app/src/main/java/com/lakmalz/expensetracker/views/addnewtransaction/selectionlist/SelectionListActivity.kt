...
import com.lakmalz.expensetracker.utils.Constant.Companion.EXTRAS_ENABLE_ADD_NEW_ACCOUNT
import com.lakmalz.expensetracker.utils.Constant.Companion.EXTRAS_SELECTION_TYPE
...
class SelectionListActivity : BaseActivity(), View.OnClickListener {
    ...
    private var selectionType: Int? = null
    ...
    override fun onClick(v: View?) {
        if (edt_name.text.isNullOrEmpty()) {
            showMessage(getString(R.string.account_is_required))
            return
        }
